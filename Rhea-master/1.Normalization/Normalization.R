...
setwd("C:/Users/usm20749/OneDrive/Misbah_Analysis/Rhea-master/1.Normalization")      #<--- CHANGE ACCORDINGLY

#' Please give the file name of the original OTU-table with taxonomic classification
file_name <- "zOTU-Table_V1V3_stool_Renamed_58_Taxonomy.tab"                   #<--- CHANGE ACCORDINGLY
